...
"""
lib_Densidad:
    -Function file to quickly create the bubble map plot.


INPUT:  coord_path       stg. file path and name of coord dataset     
        TypeData         stg. filename only of the master dataset
        Año              stg. filename only of year of the plot
OUTPUT: lista_mapas      list which contains each map  

RUN:    TBD
         
@author: VSA
Created on Tue 2020/02/04
